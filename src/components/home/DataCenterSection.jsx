        ...
        <div className="grid md:grid-cols-2 gap-8 lg:gap-12 items-start">
          ...
          <div className="space-y-6 sm:space-y-8">
            ...
            <div className="flex flex-wrap gap-3 sm:gap-4">
              <button className="bg-purple-600 text-white font-semibold px-4 sm:px-6 py-2 sm:py-3 text-sm sm:text-base rounded-full hover:bg-purple-700 transition">
                Get a digital miner
              </button>
              <button className="border border-gray-600 text-black font-semibold px-4 sm:px-6 py-2 sm:py-3 text-sm sm:text-base rounded-full hover:border-gray-700 transition">
                About data centers
              </button>
            </div>
          </div>
